...
#
MaliciousCMPKey.gen_and_save(gen_num, 'MaliciousCMPKey_0', 8)
MaliciousCMPKey.gen_and_save(gen_num, 'MaliciousCMPKey_1', 8)
MaliciousCMPKey.gen_and_save(gen_num, 'MaliciousCMPKey_2', 8)
